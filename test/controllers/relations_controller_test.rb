...
class RelationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post relations_url, params: { relation: { d_vocation_pu: @relation.d_vocation_pu, post_id: @relation.post_id, unit_id: @relation.unit_id } }
    end
  ...
  test "should update relation" do
    patch relation_url(@relation), params: { relation: { d_vocation_pu: @relation.d_vocation_pu, post_id: @relation.post_id, unit_id: @relation.unit_id } }
