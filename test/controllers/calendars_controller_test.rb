...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post calendars_url, params: { calendar: { date_c: @calendar.date_c, is_output: @calendar.is_output, year_c: @calendar.year_c } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { date_c: @calendar.date_c, is_output: @calendar.is_output, year_c: @calendar.year_c } }
